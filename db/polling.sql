...
CREATE TABLE `polling` (
  ...
  `java` int(100) DEFAULT NULL,
  `vbnet` int(100) DEFAULT NULL,
  `perl` int(100) DEFAULT NULL,
  `c` int(100) DEFAULT NULL
...
INSERT INTO `polling` VALUES (56,23,7,20,12);
...
-- Dump completed on 2012-11-06 22:00:50
